...
function h(tag) {
  ...
  var flags = null; // 标记什么类型的节点

  return {
    // VNode
    _isVNode: true,
    // 架构 Vue 的过程就是实现 VNode 的过程
    flags: flags // diff 算法优化，没有也可以很好的实现，但是会有很多垃圾的、重复的、好性能的节点类型判断代码
    // 把节点类型的判断提前
...
var elementVNode = (0, _h.h)('div', {
  ...
  target: '#portal-box'
}, [(0, _h.h)('span', null, '标题 1'), (0, _h.h)('span', null, '标题 2')]));
